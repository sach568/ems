        ...
        EN
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              Payroll Settings
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/settings/import" class="nav-link active">
              Import
            </a></li>
							</ul>
						</div>
			...
			<div class="container-fluid page-body-wrapper">
				<div class="main-panel">
					<div data-v-6723e176="" class="content-wrapper">
						<div data-v-76b88b86="" data-v-6723e176="" class="row">
						...
						<div data-v-6723e176="" class="vertical-tab">
								...
								<div class="col-md-3 pr-md-3 tab-menu">
									<div class="card card-with-shadow border-0">
										...
										<div class="px-primary py-primary">
											<div role="tablist" aria-orientation="vertical" class="nav flex-column nav-pills"><a id="v-pills-Employees-tab" data-toggle="pill" href="#Employees-0" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 active"><span>Employees</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a></div>
										</div>
									</div>
								</div>
								<div class="col-md-9 pl-md-3 pt-md-0 pt-sm-4 pt-4">
									<div class="card card-with-shadow border-0">
										<div class="tab-content px-primary">
											<div id="Employees-0" class="tab-pane fade active show">
												...
												<div class="content py-primary">
													<div id="Employees-0">
														<div class="note-title d-flex">
															...
															<h6 class="card-title pl-2">No email settings found.</h6></div>
														<div class="note note-warning p-4">
															<!---->
															<p class="m-1">
																<ol>
																	<li>Please make sure you setup the cron job on your hosted server as instructed on the <a href="https://payday.gainhq.com/documentation/important-settings.html#scheduler-queue" target="_blank">documentation</a> for sending emails.</li>
																	<li>To import employees you must set up email settings. Click <a href="https://payday.gainhq.com/app/settings?tab=Email%20setup">here</a> to add email settings.</li>
																</ol>
															</p>
														</div>
													</div>
