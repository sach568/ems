...
<head>
	...
	<title>Payroll Settings - PayDay</title>
        ...
        EN
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              Attendance Settings
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/settings/payroll-settings" class="nav-link active">
              Payroll Settings
            </a></li>
			...
			<div class="container-fluid page-body-wrapper">
				<div class="main-panel">
					<div data-v-0bba9688="" class="content-wrapper">
						<div data-v-76b88b86="" data-v-0bba9688="" class="row">
								...
								<nav data-v-76b88b86="" aria-label="breadcrumb">
									<ol class="breadcrumb p-0 d-flex align-items-center mb-primary">
										<li class="breadcrumb-item page-header d-flex align-items-center">
											<h4 class="mb-0">Payroll Settings</h4></li>
										<!---->
										<!---->
									</ol>
								</nav>
						...
						<div data-v-0bba9688="" class="vertical-tab">
							<div class="row no-gutters">
								<div class="col-md-3 pr-md-3 tab-menu">
									<div class="card card-with-shadow border-0">
										...
										<div class="px-primary py-primary">
											<div role="tablist" aria-orientation="vertical" class="nav flex-column nav-pills"><a id="v-pills-Default Payrun-tab" data-toggle="pill" href="#Default Payrun-0" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 active"><span>Default Payrun</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a><a id="v-pills-Badge Value-tab" data-toggle="pill" href="#Badge Value-1" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3"><span>Badge Value</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a><a id="v-pills-Manage audience-tab" data-toggle="pill" href="#Manage audience-2" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3"><span>Manage audience</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a><a id="v-pills-Payslip-tab" data-toggle="pill" href="#Payslip-3" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3"><span>Payslip</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a></div>
										</div>
									</div>
								</div>
								<div class="col-md-9 pl-md-3 pt-md-0 pt-sm-4 pt-4">
									<div class="card card-with-shadow border-0">
										<div class="tab-content px-primary">
											<div id="Default Payrun-0" class="tab-pane fade active show">
                                ...
                                Default Payrun</h5>
												...
												<div class="content py-primary">
													<form data-url="app/settings/payrun" id="Default Payrun-0">
														<div class="mb-primary">
															<div class="note-title d-flex">
																...
																<h6 class="card-title pl-2">How payrun works?</h6></div>
															<div class="note note-warning p-4">
																<!---->
																<p class="m-1">
																	<ol>
																		<li>Default payrun is applicable to generate payslip for all employees (Except those are updated individually) whenever it execute from <a href="https://payday.gainhq.com/payroll/payrun">Payrun</a> module.</li>
																		<li>You can set payrun individually over the default from the <a href="https://payday.gainhq.com/employee/lists">Employees</a> details.</li>
																	</ol>
																</p>
															</div>
														</div>
														<div class="form-group" list="[object Object],[object Object],[object Object]">
															<div class="row align-items-center">
																<div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 col-xs-12">
																	<label class="text-left d-block mb-lg-0"> Payrun period
																		<!---->
																		<!---->
																	</label>
																</div>
																<div class="col-lg-8 col-xl-8 col-md-8 col-sm-12 col-xs-12">
																	<div>
																		<select id="formData.payrun_period" class="custom-select" style="background-image: url(&quot;https://payday.gainhq.com/images/chevron-down.svg&quot;);">
																			<option disabled="disabled" value=""> Choose payrun period </option>
																			<option value="monthly"> Monthly </option>
																			<option value="weekly"> Weekly </option>
																		</select>
																		<!---->
																	</div> <small class="text-muted font-italic">
                Always run for the last month
            </small></div>
															</div>
														</div>
														<div class="form-group" radio-checkbox-name="consider_type" list="[object Object],[object Object],[object Object]">
															<div class="row align-items-center">
																<div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 col-xs-12">
																	<label class="text-left d-block mb-lg-0"> Payrun generating type
																		<!---->
																		<!---->
																	</label>
																</div>
																	...
																	<div>
																		<div class="app-radio-group">
																			<label class="customized-radio radio-default custom-radio-default">
																				<input type="radio" name="consider_type" id="consider_type-0" class="radio-inline" value="hour"> <span class="outside"><span class="inside"></span></span> Hour </label>
																			<label class="customized-radio radio-default custom-radio-default">
																				<input type="radio" name="consider_type" id="consider_type-1" class="radio-inline" value="daily_log"> <span class="outside"><span class="inside"></span></span> Daily Log </label>
																			<label class="customized-radio radio-default custom-radio-default">
																				<input type="radio" name="consider_type" id="consider_type-2" class="radio-inline" value="none"> <span class="outside"><span class="inside"></span></span> None </label>
																		</div>
																		<!---->
																	</div>
																</div>
