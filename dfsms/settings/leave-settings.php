...
<head>
	...
	<title>Leave Settings - PayDay</title>
        ...
        EN
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              App Settings
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/settings/leave-settings" class="nav-link active">
              Leave Settings
            </a></li>
			...
			<div class="container-fluid page-body-wrapper">
				<div class="main-panel">
					<div data-v-8bef4dac="" class="content-wrapper">
						<div data-v-76b88b86="" data-v-8bef4dac="" class="row">
								...
								<nav data-v-76b88b86="" aria-label="breadcrumb">
									<ol class="breadcrumb p-0 d-flex align-items-center mb-primary">
										<li class="breadcrumb-item page-header d-flex align-items-center">
											<h4 class="mb-0">Leave Settings</h4></li>
										<!---->
										<!---->
									</ol>
								</nav>
						...
						<div data-v-8bef4dac="" class="vertical-tab">
								...
								<div class="col-md-3 pr-md-3 tab-menu">
									<div class="card card-with-shadow border-0">
										...
										<div class="px-primary py-primary">
											<div role="tablist" aria-orientation="vertical" class="nav flex-column nav-pills"><a id="v-pills-Leave Type-tab" data-toggle="pill" href="#Leave Type-0" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3 active"><span>Leave Type</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a><a id="v-pills-Allowance Policy-tab" data-toggle="pill" href="#Allowance Policy-1" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3"><span>Allowance Policy</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a><a id="v-pills-approval-tab" data-toggle="pill" href="#approval-2" class="text-capitalize tab-item-link d-flex justify-content-between my-2 my-sm-3"><span>approval</span> <span class="active-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a></div>
										</div>
									</div>
								</div>
								<div class="col-md-9 pl-md-3 pt-md-0 pt-sm-4 pt-4">
									<div class="card card-with-shadow border-0">
										<div class="tab-content px-primary">
											<div id="Leave Type-0" class="tab-pane fade active show">
            ...
            Created
																...
																<div class="single-filter checkbox-filter">
																	<div class="dropdown keep-inside-clicks-open">
																		<button id="type-leave-types-table" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter"> Type
																			<!---->
																		</button>
																		<div aria-labelledby="type-leave-types-table" class="dropdown-menu">
																			<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Type
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
																			<div class="dropdown-item">
																					...
																					<div class="col-6">
																						<div class="form-group">
																							<div class="customized-checkbox checkbox-default">
																								<input type="checkbox" id="input-checkbox-paid">
																								<label for="input-checkbox-paid"> Paid </label>
																							</div>
																						</div>
																					</div>
																					<div class="col-6">
																						<div class="form-group">
																							<div class="customized-checkbox checkbox-default">
																								<input type="checkbox" id="input-checkbox-unpaid">
																								<label for="input-checkbox-unpaid"> Unpaid </label>
																							</div>
																						</div>
																					</div>
																					<div class="col-6">
																						<div class="form-group">
																							<div class="customized-checkbox checkbox-default">
																								<input type="checkbox" id="input-checkbox-special">
																								<label for="input-checkbox-special"> Special </label>
																							</div>
																						</div>
																					</div>
																				</div>
													...
													<div class="card border-0 bg-transparent">
														<div class="card-body p-0">
															<div class="datatable">
																...
																<!---->
																<!---->
																<div class="table-responsive custom-scrollbar table-view-responsive pt-primary">
                            ...
                            Allow monthly earning
																				...
																				<th track-by="5" class="datatable-th pt-0 text-right"><span class="font-size-default">
                        Actions
                    </span></th>
																			</tr>
																		</thead>
																		<tbody>
																			<tr>
																				<!---->
																				<td data-title="Name" class="datatable-td"><span class="">
                            Paid Casual
                        </span></td>
																				<td data-title="Type" class="datatable-td"><span>Paid</span></td>
																				<td data-title="Amount" class="datatable-td"><span class="">
                            5.50
                        </span></td>
																				<td data-title="Enabled" class="datatable-td"><span>Yes</span></td>
																				<td data-title="Allow monthly earning" class="datatable-td"><span class=""><div table-id="leave-types-table" index="4"><div><label class="custom-control d-inline border-switch mb-0 mr-3"><input type="checkbox" name="switchValue" id="switchValue" class="border-switch-control-input" value="0"> <span class="border-switch-control-indicator"></span></label>
																					<!---->
																</div>
															</div>
															</span>
															</td>
															<td data-title="Actions" class="datatable-td text-md-right"><span><div role="group" aria-label="Default action" class="btn-group btn-group-action"><button type="button" data-toggle="tooltip" data-placement="top" title="" class="btn" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg></button><button type="button" data-toggle="tooltip" data-placement="top" title="" class="btn" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></button></div></span></td>
															</tr>
															<!---->
															<tr>
																<!---->
                            ...
                            Unpaid Casual
														...
														<td data-title="Type" class="datatable-td"><span>Unpaid</span></td>
														<td data-title="Amount" class="datatable-td"><span class="">
                            5.50
                        </span></td>
														<td data-title="Enabled" class="datatable-td"><span>Yes</span></td>
