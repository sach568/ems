...
<body>
        ...
        EN
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              Payrun
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/payroll/payslip" class="nav-link active">
              Payslip
            </a></li>
			...
			<div class="container-fluid page-body-wrapper">
				<div class="main-panel">
					<div data-v-3d1ce746="" class="content-wrapper">
						<div data-v-76b88b86="" data-v-3d1ce746="" class="row">
							...
							<div data-v-76b88b86="" class="col-sm-12 col-md-6">
								<div data-v-76b88b86="" class="float-md-right mb-3 mb-sm-3 mb-md-0">
									<button data-v-6f2921d8="" data-v-3d1ce746="" class="btn btn-success mr-2" data-v-76b88b86=""> Send Filtered Payslip </button>
									<button data-v-6f2921d8="" data-v-3d1ce746="" class="btn btn-primary" data-v-76b88b86=""> Send Monthly Payslip </button>
								</div>
							</div>
						</div>
						<!---->
						<div data-v-3d1ce746="" class="d-flex justify-content-between">
							<div>
                    ...
                    <span class="check-sign float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check menu-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></span></a></div>
							...
							<div class="single-filter radio-filter">
								<div class="dropdown keep-inside-clicks-open">
									<button type="button" id="type-undefined" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter"> Type
										<!---->
									</button>
									<div aria-labelledby="type-undefined" class="dropdown-menu">
										<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Type
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
										<div class="dropdown-item pb-0">
											<h6>Filter data by Payrun Type.</h6>
											<p class="text-justify mb-0 filter-subtitle-text"> You can filter the data table based on which Payrun Type applied to generated the Payslips. </p>
										</div>
										<div class="dropdown-item">
											<label class="customized-radio radio-default d-block mb-3">
												<input type="radio" name="customRadio" id="input-radio-manual" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Manual </label>
											<label class="customized-radio radio-default d-block">
												<input type="radio" name="customRadio" id="input-radio-default" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Default </label>
										</div>
										<div class="dropdown-divider d-none d-sm-block"></div>
										<div class="dropdown-item">
											<div class="row filter-action-button-wrapper">
												<div class="col-12 d-flex justify-content-between">
													<button type="button" disabled="disabled" class="btn btn-clear pl-sm-0"> Clear </button>
							...
							<div class="single-filter radio-filter">
								<div class="dropdown keep-inside-clicks-open">
									<button type="button" id="payrun_period-undefined" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter"> Payrun period
										<!---->
									</button>
									<div aria-labelledby="payrun_period-undefined" class="dropdown-menu">
										<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Payrun period
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
										<div class="dropdown-item pb-0">
											<h6>Filter data by Payrun Period.</h6>
											<p class="text-justify mb-0 filter-subtitle-text"> You can filter the data table based on which Payrun Period applied to generated the Payslips. </p>
										</div>
										<div class="dropdown-item">
											<label class="customized-radio radio-default d-block mb-3">
												<input type="radio" name="customRadio" id="input-radio-monthly" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Monthly </label>
											<label class="customized-radio radio-default d-block">
												<input type="radio" name="customRadio" id="input-radio-weekly" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Weekly </label>
										</div>
										<div class="dropdown-divider d-none d-sm-block"></div>
										<div class="dropdown-item">
											<div class="row filter-action-button-wrapper">
			...
			<div data-v-3d1ce746="" class="card card-with-shadow border-0" style="min-height: 400px;">
				<div data-v-3d1ce746="">
					<div data-v-3d1ce746="" class="card-header d-flex align-items-center justify-content-between primary-card-color p-primary mb-primary">
						<div data-v-3d1ce746="" class="d-flex justify-content-between mb-3 mb-lg-0">
						...
						<ul data-v-aca59184="" data-v-3d1ce746="" class="nav tab-filter-menu d-flex align-items-center">
					...
					<div class="datatable">
						...
						<div class="table-responsive custom-scrollbar table-view-responsive px-0">
                            ...
                            Details
										...
										<th track-by="8" class="datatable-th pt-0"><span class="font-size-default"><span>
                            Email
                        </span></span>
										</th>
										<th track-by="9" class="datatable-th pt-0 text-right"><span class="font-size-default">
                        Actions
                    </span></th>
									</tr>
								</thead>
								<tbody>
									<tr>
										<!---->
										<td data-title="Profile" class="datatable-td"><span class=""><div class="media align-items-center min-width-200" table-id="payslip-table"><div class="avatars-w-50"><div class="no-img rounded-circle">
        JD
					...
					<td data-title="Payrun" class="datatable-td"><span><span class="min-width-130 d-block">1 - 31 Oct 2021</span>
						<p class="pt-1 font-size-90 text-muted">ID: XGAYEKFI</p>
						</span>
					</td>
	...
	<td data-title="Salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 50,000</span></span>
	</td>
	<td data-title="Net salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 54,000</span></span>
	</td>
	<td data-title="Details" class="datatable-td"><span><button class="btn btn-secondary d-inline-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                View
                            </button></span></td>
	...
	<tr>
		...
		<td data-title="Salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 40,000</span></span>
		</td>
		<td data-title="Net salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 43,200</span></span>
		</td>
		<td data-title="Details" class="datatable-td"><span><button class="btn btn-secondary d-inline-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                View
                            </button></span></td>
	...
	<tr>
		...
		<td data-title="Salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 20,000</span></span>
		</td>
		<td data-title="Net salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 21,600</span></span>
		</td>
		<td data-title="Details" class="datatable-td"><span><button class="btn btn-secondary d-inline-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                View
                            </button></span></td>
	...
	<tr>
		...
		<td data-title="Salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 10,000</span></span>
		</td>
		<td data-title="Net salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 10,800</span></span>
		</td>
		<td data-title="Details" class="datatable-td"><span><button class="btn btn-secondary d-inline-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                View
                            </button></span></td>
	...
	<tr>
		...
		<td data-title="Salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 30,000</span></span>
		</td>
		<td data-title="Net salary" class="datatable-td"><span><span class="min-width-100 d-block">$ 32,400</span></span>
		</td>
		<td data-title="Details" class="datatable-td"><span><button class="btn btn-secondary d-inline-flex align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                                View
                            </button></span></td>
