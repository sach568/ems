...
<head>
	...
	<title>Beneficiary - PayDay</title>
        ...
        EN
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              Summary
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/payroll/beneficiary-badges" class="nav-link active">
              Beneficiary badge
            </a></li>
							</ul>
						</div>
						...
						<div data-v-76b88b86="" class="row">
								...
								<nav data-v-76b88b86="" aria-label="breadcrumb">
									<ol class="breadcrumb p-0 d-flex align-items-center mb-primary">
										<li class="breadcrumb-item page-header d-flex align-items-center">
											<h4 class="mb-0">Beneficiary badge</h4></li>
										<!---->
										<!---->
									</ol>
								</nav>
							...
							<div data-v-76b88b86="" class="col-sm-12 col-md-6">
								<div data-v-76b88b86="" class="float-md-right mb-3 mb-sm-3 mb-md-0">
									<button data-v-6f2921d8="" class="btn btn-primary" data-v-76b88b86=""> Add Badge </button>
								</div>
							</div>
						</div>
						<div>
            ...
            Created
								...
								<div class="single-filter radio-filter">
									<div class="dropdown keep-inside-clicks-open">
										<button type="button" id="type-beneficiary-badge-table" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter"> Type
											<!---->
										</button>
										<div aria-labelledby="type-beneficiary-badge-table" class="dropdown-menu">
											<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Type
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
											<div class="dropdown-item pb-0">
												<h6>Filter data by Beneficiary Type.</h6>
												<p class="text-justify mb-0 filter-subtitle-text"> You can filter the data table based on Beneficiary Type. </p>
											</div>
											<div class="dropdown-item">
												<label class="customized-radio radio-default d-block mb-3">
													<input type="radio" name="customRadio" id="input-radio-allowance" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Allowance </label>
												<label class="customized-radio radio-default d-block">
													<input type="radio" name="customRadio" id="input-radio-deduction" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Deduction </label>
											</div>
											<div class="dropdown-divider d-none d-sm-block"></div>
											<div class="dropdown-item">
												<div class="row filter-action-button-wrapper">
								...
								<div class="single-filter radio-filter">
									<div class="dropdown keep-inside-clicks-open">
										<button type="button" id="status-beneficiary-badge-table" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter"> Status
											<!---->
										</button>
										<div aria-labelledby="status-beneficiary-badge-table" class="dropdown-menu">
											<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Status
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
											<div class="dropdown-item pb-0">
												<h6>Filter data by Beneficiary Status.</h6>
												<p class="text-justify mb-0 filter-subtitle-text"> You can filter the data table based on Beneficiary Status. </p>
											</div>
											<div class="dropdown-item">
												<label class="customized-radio radio-default d-block mb-3">
													<input type="radio" name="customRadio" id="input-radio-active" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Active </label>
												<label class="customized-radio radio-default d-block">
													<input type="radio" name="customRadio" id="input-radio-inactive" class="radio-inline"> <span class="outside"><span class="inside"></span></span> Inactive </label>
											</div>
											<div class="dropdown-divider d-none d-sm-block"></div>
											<div class="dropdown-item">
												<div class="row filter-action-button-wrapper">
					...
					<div class="card border-0 bg-transparent">
							...
							<div class="datatable">
								...
								<div class="my-2 d-flex justify-content-between">
									<div class="d-flex align-items-center">
										<p class="text-muted mb-0"> Showing 1 to 2 items of 2 </p>
										<!---->
										<!---->
									</div>
									<!---->
                        ...
                        Actions
                            ...
                            Tax
												...
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Type" class="datatable-td"><span><span class="badge badge-pill badge-warning">
                                Deduction
                            </span></span>
												</td>
												<td data-title="Status" class="datatable-td"><span class=""><div table-id="beneficiary-badge-table" index="3"><div><label class="custom-control d-inline border-switch mb-0 mr-3"><input type="checkbox" name="switchValue" id="switchValue" class="border-switch-control-input" value="1"> <span class="border-switch-control-indicator"></span></label>
													<!---->
								</div>
							</div>
							</span>
							</td>
							<td data-title="Created" class="datatable-td"><span></span></td>
            ...
            Delete
                            ...
                            Bonus
								...
								<td data-title="Description" class="datatable-td"><span>-</span></td>
								<td data-title="Type" class="datatable-td"><span><span class="badge badge-pill badge-success">
                                Allowance
                            </span></span>
								</td>
								<td data-title="Status" class="datatable-td"><span class=""><div table-id="beneficiary-badge-table" index="3"><div><label class="custom-control d-inline border-switch mb-0 mr-3"><input type="checkbox" name="switchValue" id="switchValue" class="border-switch-control-input" value="1"> <span class="border-switch-control-indicator"></span></label>
