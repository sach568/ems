...
<head>
	...
	<title>Departments - PayDay</title>
	...
	<link media="all" type="text/css" rel="stylesheet" href="https://payday.gainhq.com/vendor/summernote/summernote-bs4.css">s
</head>
        ...
        EN
									...
									<li class="nav-item nav-profile dropdown">
										<a id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false" class="d-flex align-items-center nav-link dropdown-toggle mr-0">
											<div class="nav-profile-text">
												<p class="mb-0 text-black text-right"> John Doe
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              Work Shifts
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/administration/departments" class="nav-link active">
              Departments
            </a></li>
						...
						<div data-v-76b88b86="" class="row">
								...
								<nav data-v-76b88b86="" aria-label="breadcrumb">
									<ol class="breadcrumb p-0 d-flex align-items-center mb-primary">
										<li class="breadcrumb-item page-header d-flex align-items-center">
											<h4 class="mb-0">Departments</h4></li>
										<!---->
										<!---->
									</ol>
								</nav>
							...
							<div data-v-76b88b86="" class="col-sm-12 col-md-6">
								<div data-v-76b88b86="" class="float-md-right mb-3 mb-sm-3 mb-md-0">
									<button data-v-6f2921d8="" class="btn btn-primary" data-v-76b88b86=""> Add Department </button>
								</div>
							</div>
						</div>
						<div>
            ...
            Created
								...
								<div class="single-filter checkbox-filter">
									<div class="dropdown keep-inside-clicks-open">
										<button id="status-department-table" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter"> Status
											<!---->
										</button>
										<div aria-labelledby="status-department-table" class="dropdown-menu">
											<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Status
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
											<div class="dropdown-item">
													...
													<div class="col-6">
														<div class="form-group">
															<div class="customized-checkbox checkbox-default">
																...
																<label for="input-checkbox-4"> Active </label>
															</div>
														</div>
													</div>
													<div class="col-6">
														<div class="form-group">
															<div class="customized-checkbox checkbox-default">
																...
																<label for="input-checkbox-5"> Inactive </label>
															</div>
														</div>
													</div>
												</div>
					...
					<div class="card border-0 bg-transparent">
							...
							<div class="datatable">
								...
								<div class="my-2 d-flex justify-content-between">
									<div class="d-flex align-items-center">
										<p class="text-muted mb-0"> Showing 1 to 6 items of 6 </p>
										<!---->
										<!---->
									</div>
									<!---->
                        ...
                        Actions
                            ...
                            UI &amp; UX
												...
												<td data-title="Manager" class="datatable-td"><span>Grayson Dare</span></td>
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Status" class="datatable-td"><span><span class="badge badge-pill badge-primary">
                                Active
                            </span></span>
												</td>
												<td data-title="Parent department" class="datatable-td"><span>Development</span></td>
												<td data-title="Location" class="datatable-td"><span>-</span></td>
												<td data-title="Created" class="datatable-td"><span>02-11-2021</span></td>
            ...
            Move employee
                            ...
                            Software
												...
												<td data-title="Manager" class="datatable-td"><span>Aimee Beer</span></td>
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Status" class="datatable-td"><span><span class="badge badge-pill badge-primary">
                                Active
                            </span></span>
            ...
            Move employee
                            ...
                            Development
												...
												<td data-title="Manager" class="datatable-td"><span>Isac Hammes</span></td>
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Status" class="datatable-td"><span><span class="badge badge-pill badge-primary">
                                Active
                            </span></span>
												</td>
												<td data-title="Parent department" class="datatable-td"><span>Main Department</span></td>
												<td data-title="Location" class="datatable-td"><span>-</span></td>
												<td data-title="Created" class="datatable-td"><span>02-11-2021</span></td>
												<td data-title="Actions" class="datatable-td text-md-right"><span><div class="dropdown options-dropdown d-inline-block"><button type="button" data-toggle="dropdown" title="Actions" class="btn-option btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></button> <div class="dropdown-menu dropdown-menu-right py-2 mt-1"><a href="#" class="dropdown-item px-4 py-2">
            Edit
            ...
            Move employee
                            ...
                            Accounts
												...
												<td data-title="Manager" class="datatable-td"><span>Kim Schmitt</span></td>
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Status" class="datatable-td"><span><span class="badge badge-pill badge-primary">
                                Active
                            </span></span>
												</td>
												<td data-title="Parent department" class="datatable-td"><span>Admin &amp; HRM</span></td>
												<td data-title="Location" class="datatable-td"><span>-</span></td>
												<td data-title="Created" class="datatable-td"><span>02-11-2021</span></td>
												<td data-title="Actions" class="datatable-td text-md-right"><span><div class="dropdown options-dropdown d-inline-block"><button type="button" data-toggle="dropdown" title="Actions" class="btn-option btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></button> <div class="dropdown-menu dropdown-menu-right py-2 mt-1"><a href="#" class="dropdown-item px-4 py-2">
            Edit
            ...
            Move employee
                            ...
                            Admin &amp; HRM
												...
												<td data-title="Manager" class="datatable-td"><span>Tony Stark</span></td>
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Status" class="datatable-td"><span><span class="badge badge-pill badge-primary">
                                Active
                            </span></span>
            ...
            Move employee
                            ...
                            Main Department
												...
												<td data-title="Manager" class="datatable-td"><span>John Doe</span></td>
												<td data-title="Description" class="datatable-td"><span>-</span></td>
												<td data-title="Status" class="datatable-td"><span><span class="badge badge-pill badge-primary">
                                Active
                            </span></span>
												</td>
												<td data-title="Parent department" class="datatable-td"><span>-</span></td>
												<td data-title="Location" class="datatable-td"><span>-</span></td>
												<td data-title="Created" class="datatable-td"><span>02-11-2021</span></td>
												<td data-title="Actions" class="datatable-td text-md-right"><span><div class="dropdown options-dropdown d-inline-block"><button type="button" data-toggle="dropdown" title="Actions" class="btn-option btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-more-vertical"><circle cx="12" cy="12" r="1"></circle><circle cx="12" cy="5" r="1"></circle><circle cx="12" cy="19" r="1"></circle></svg></button> <div class="dropdown-menu dropdown-menu-right py-2 mt-1"><a href="#" class="dropdown-item px-4 py-2">
            Edit
