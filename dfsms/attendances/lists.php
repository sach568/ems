...
<body>
	<div id="app">
              ...
              Summary
					...
					<li class="nav-item active"><a href="#attendance_menu" data-toggle="collapse" aria-expanded="false" aria-controls="attendance_menu" class="nav-link"><span class="icon-wrapper"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar menu-icon"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg></span> <span class="menu-title">Attendance</span> <i class="menu-arrow"></i></a>
						<div id="attendance_menu" class="collapse show">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a href="https://payday.gainhq.com/attendances/lists" class="nav-link active">
              Daily Log
            </a></li>
				...
				<div class="main-panel">
                    ...
                    Manage Columns
														...
														<div>
															...
															<div class="row py-2">
																<div class="col-12 d-flex justify-content-between">
																	...
																	<label class="custom-control border-switch mb-0 mr-3">
																		<input type="checkbox" id="switch-7" class="border-switch-control-input"> <span class="border-switch-control-indicator"></span></label>
																</div>
															</div>
														</div>
													</div>
										...
										<button type="button" class="btn d-block d-sm-none btn-toggle-filters">
											...
											</svg> Filters </button> <span class="mobile-filters-wrapper"><div class="filters-loop-wrapper"><!----> <!----> <!----> <!----> <!----> <!----> <!----> <div class="single-filter date-filter"><span><button id="date-daily-log" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter">
                Today
                <!----></button><div data-v-05016e86="" class="vc-popover-content-wrapper"><!----></div></span></div>
									<!---->
									<!---->
									<!---->
									<!---->
            ...
            <!----></a>
                    ...
                    <span class="check-sign float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check menu-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></span></a></div>
									...
									<div class="single-filter search-filter-dropdown">
										<div class="dropdown"><a href="#" id="working_shifts-daily-log" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter px-3">
            Work Shift
            <!----> <!----></a>
											<div aria-labelledby="working_shifts-daily-log" class="dropdown-menu py-0">
												<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Work Shift
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
												<div class="form-group form-group-with-search"><span class="form-control-feedback"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></span>
                    ...
                    <span class="check-sign float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check menu-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></span></a></div>
									...
									<!---->
									<div class="single-filter search-filter-dropdown">
										<div class="dropdown"><a href="#" id="behavior-daily-log" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter px-3">
            Behavior
            <!----> <!----></a>
											<div aria-labelledby="behavior-daily-log" class="dropdown-menu py-0">
												<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Behavior
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
												<div class="form-group form-group-with-search"><span class="form-control-feedback"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></span>
                    ...
                    <span class="check-sign float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check menu-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></span></a></div>
									...
									<!---->
									<div class="single-filter search-filter-dropdown">
										<div class="dropdown"><a href="#" id="type-daily-log" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-filter px-3">
            Type
            <!----> <!----></a>
											<div aria-labelledby="type-daily-log" class="dropdown-menu py-0">
												<div class="btn-dropdown-close d-sm-none"><span class="title">
                    Type
                </span> <span class="back float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></div>
												<div class="form-group form-group-with-search"><span class="form-control-feedback"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></span>
					...
					<div class="h-100">
						<div class="card border-0 bg-transparent">
								...
								<div class="datatable">
									...
									<div class="my-2 d-flex justify-content-between">
										<div class="d-flex align-items-center">
											<p class="text-muted mb-0"> Showing 1 to 10 items of 10 </p>
											<!---->
											<!---->
										</div>
										<!---->
                            ...
                            Entry
													...
													<th track-by="7" class="datatable-th pt-0 text-right"><span class="font-size-default">
                        Actions
                    </span></th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<!---->
													<td data-title="Profile" class="datatable-td"><span class=""><div class="media align-items-center min-width-200" table-id="daily-log"><div class="avatars-w-50"><div class="no-img rounded-circle">
        DZ
								...
								<td data-title="Punched in" class="datatable-td"><span class=""><div data-v-25347b7e="" class="d-flex align-items-center" row-data="[object Object]" index="1"><span class="mr-1">11:34 AM, Today</span>
									<!---->
							</div>
							</span>
							</td>
							<td data-title="Behavior" class="datatable-td"><span><span class="badge badge-pill badge-warning">Early</span></span>
							</td>
							<td data-title="Punched Out" class="datatable-td"><span class=""><div data-v-765caedb="" class="d-flex align-items-center" row-data="[object Object]" index="3"><span class="mr-1">7:34 PM, Today</span>
								<!---->
						</div>
						</span>
						</td>
						<td data-title="Type" class="datatable-td"><span class=""><div data-v-60bce9e8="" class="d-inline-block" row-data="[object Object]" index="4"><span data-v-60bce9e8="">Auto</span>
							<!---->
					</div>
					</span>
					</td>
					<td data-title="Total hours" class="datatable-td"><span>08:00</span></td>
					<td data-title="Entry" class="datatable-td"><span class="table-expanded-column"><span class="d-inline-flex"><!----> <span class="badge rounded-pill badge-success">
                                            Single
                                        </span>
						<!---->
						</span>
		...
		<td data-title="Punched Out" class="datatable-td"><span class=""><div data-v-765caedb="" class="d-flex align-items-center" row-data="[object Object]" index="3"><span class="mr-1">6:34 PM, Today</span>
			<!---->
	</div>
	</span>
	</td>
	...
	<td data-title="Total hours" class="datatable-td"><span>07:00</span></td>
	<td data-title="Entry" class="datatable-td"><span class="table-expanded-column"><span class="d-inline-flex"><!----> <span class="badge rounded-pill badge-success">
                                            Single
                                        </span>
		<!---->
	...
	<tr>
		...
		<td data-title="Punched Out" class="datatable-td"><span class=""><div data-v-765caedb="" class="d-flex align-items-center" row-data="[object Object]" index="3"><span class="mr-1">5:34 PM, Today</span>
			<!---->
			</div>
			</span>
		</td>
		...
		<td data-title="Total hours" class="datatable-td"><span>06:00</span></td>
		<td data-title="Entry" class="datatable-td"><span class="table-expanded-column"><span class="d-inline-flex"><!----> <span class="badge rounded-pill badge-success">
                                            Single
                                        </span>
			<!---->
	...
	<tr>
        ...
        JH
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/8/profile">Josiane Huel</a>
				<p class="text-muted font-size-90 mb-0">Accounts</p>
			</div>
			</div>
			</span>
		</td>
		...
		<td data-title="Punched Out" class="datatable-td"><span class=""><div data-v-765caedb="" class="d-flex align-items-center" row-data="[object Object]" index="3"><span class="mr-1">8:34 PM, Today</span>
			<!---->
			</div>
			</span>
		</td>
	...
	<tr>
        ...
        MK
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/6/profile">Martin Kulas</a>
				<p class="text-muted font-size-90 mb-0">Development</p>
			</div>
			</div>
			</span>
		...
		<td data-title="Punched Out" class="datatable-td"><span class=""><div data-v-765caedb="" class="d-flex align-items-center" row-data="[object Object]" index="3"><span class="mr-1">4:34 PM, Today</span>
			<!---->
			</div>
			</span>
		</td>
		...
		<td data-title="Total hours" class="datatable-td"><span>05:00</span></td>
		<td data-title="Entry" class="datatable-td"><span class="table-expanded-column"><span class="d-inline-flex"><!----> <span class="badge rounded-pill badge-success">
                                            Single
                                        </span>
			<!---->
	...
	<tr>
        ...
        DG
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/5/profile">Deron Gleason</a>
				<p class="text-muted font-size-90 mb-0">Admin &amp; HRM</p>
			</div>
			</div>
			</span>
		</td>
	...
	<tr>
        ...
        DB
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/4/profile">Dr. Banner</a>
				<p class="text-muted font-size-90 mb-0">Main Department</p>
			</div>
			</div>
			</span>
		</td>
	...
	<tr>
        ...
        TS
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/3/profile">Tony Stark</a>
				<p class="text-muted font-size-90 mb-0">Main Department</p>
			</div>
			</div>
			</span>
	...
	<tr>
        ...
        SR
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/2/profile">Steve Rogers</a>
				<p class="text-muted font-size-90 mb-0">Development</p>
			</div>
			</div>
			</span>
	...
	<tr>
        ...
        JD
			...
			<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/1/profile">John Doe</a>
				<p class="text-muted font-size-90 mb-0">Main Department</p>
			</div>
			</div>
			</span>
