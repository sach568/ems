        ...
        EN
			...
			<nav id="sidebar" class="sidebar sidebar-offcanvas">
              ...
              Attendance Details
								...
								<li class="nav-item"><a href="https://payday.gainhq.com/attendances/summaries" class="nav-link active">
              Summary
            </a></li>
							</ul>
						</div>
            ...
            <!----> <span class="clear-icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></span></a>
                    ...
                    <span class="check-sign float-right"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check menu-icon"><polyline points="20 6 9 17 4 12"></polyline></svg></span></a></div>
							...
							<div class="single-filter avatars-filter">
								<div class="indicator-left" disabled="disabled"></div>
								<div class="avatar-group overflow-hidden">
									<div class="avatar-carousel-wrapper" style="transform: translateX(0px);">
										...
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Deron Gleason"> DG </div> <span class="status bg-success"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Martin Kulas"> MK </div> <span class="status bg-success"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Tania Hessel"> TH </div> <span class="status bg-danger"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Josiane Huel"> JH </div> <span class="status bg-success"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Shayna Wolf"> SW </div> <span class="status bg-danger"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Beulah Ortiz"> BO </div> <span class="status bg-danger"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Lilly Mertz"> LM </div> <span class="status bg-success"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Elouise Tremblay"> ET </div> <span class="status bg-danger"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Colt Hill"> CH </div> <span class="status bg-success"></span></div>
										<div class="position-relative d-inline-block single-avatar">
											<div data-toggle="tooltip" data-placement="top" title="" class="no-img rounded-circle avatar-bordered" data-original-title="Dee Ziemann"> DZ </div> <span class="status bg-success"></span></div>
									</div>
								</div>
            ...
            This year
				...
				<div class="card-body p-primary">
					<div class="d-flex justify-content-between">
						<div class="media align-items-center">
							<div class="avatars-w-50">
								<div class="no-img rounded-circle"> JD </div> <span class="status bg-success"></span></div>
							<div class="media-body ml-3"><a href="https://payday.gainhq.com/employees/1/profile">John Doe</a>
								<p class="text-muted font-size-90 mb-0"> admin@demo.com </p>
							</div>
						</div>
						<div class="d-flex align-items-center"><a href="#" class="disabled text-muted">
                        Previous
                    </a> <span class="text-muted px-2">|</span> <a href="#" class="">
                        Next
                    </a></div>
					</div>
					<div class="row my-5">
							...
							<div class="row align-items-center justify-content-center">
									...
									<div>
										<div class="Chart">
											<div class="">
												...
												<canvas id="dough-chart" width="172" height="212" style="display: block; height: 170px; width: 138px;" class="chartjs-render-monitor"></canvas>
											</div>
										</div>
									</div>
								</div>
								<div class="col-6 col-md-5 col-lg-7">
									<div class="chart-data-list">
										<div class="data-group-item" style="color: rgb(249, 104, 104);"><span class="square" style="background-color: rgb(249, 104, 104);"></span> Regular <span class="value">0 Days</span></div>
										<div class="data-group-item" style="color: rgb(68, 102, 242);"><span class="square" style="background-color: rgb(68, 102, 242);"></span> Early <span class="value">1 Days</span></div>
										<div class="data-group-item" style="color: rgb(194, 46, 120);"><span class="square" style="background-color: rgb(194, 46, 120);"></span> Late <span class="value">0 Days</span></div>
										<div class="data-group-item" style="color: rgb(106, 0, 138);"><span class="square" style="background-color: rgb(106, 0, 138);"></span> On leave <span class="value">0 Days</span></div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-6 col-lg-4 mb-3">
									<div class="default-base-color text-center rounded p-3">
										<h5>176:00:00 h</h5>
										<p class="text-muted mb-0">Total schedule hour</p>
									</div>
								</div>
								<div class="col-md-6 col-lg-4 mb-3">
									<div class="default-base-color text-center rounded p-3">
								...
								<div class="col-md-6 col-lg-4 mb-3">
									<div class="default-base-color text-center rounded p-3">
										<h5 class="text-danger">3.98%</h5>
										<p class="text-muted mb-0">Total work availability</p>
									</div>
								</div>
								<div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
									<div class="default-base-color text-center rounded p-3">
										<h5>7:00:00 h</h5>
										<p class="text-muted mb-0"> Total active hour </p>
									</div>
								</div>
								<div class="col-md-6 col-lg-4 mb-3 mb-lg-0">
									<div class="default-base-color text-center rounded p-3">
										<h5>-169:00:00 h</h5>
										<p class="text-muted mb-0">Balance (Lack)</p>
									</div>
								</div>
								<div class="col-md-6 col-lg-4">
									<div class="default-base-color text-center rounded p-3">
										<h5 class="text-warning">Early</h5>
										<p class="text-muted mb-0"> Average Behaviour </p>
									</div>
								</div>
							</div>
						</div>
					...
					<div data-v-cf1f6f9e="">
						<div data-v-cf1f6f9e="" class="remove-datatable-x-padding">
							<!---->
							<div class="datatable">
								<!---->
								<!---->
                        ...
                        Actions
										...
										<tbody>
											<tr>
												<!---->
												<td data-title="Date" class="datatable-td"><span>01-11-2021</span></td>
