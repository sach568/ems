...
<head>
	...
	<title>Designation - PayDay</title>
...
<body>
						...
						<div data-v-76b88b86="" class="row">
								...
								<nav data-v-76b88b86="" aria-label="breadcrumb">
									<ol class="breadcrumb p-0 d-flex align-items-center mb-primary">
										<li class="breadcrumb-item page-header d-flex align-items-center">
											<h4 class="mb-0">Designation</h4></li>
										<!---->
										<!---->
									</ol>
								</nav>
							...
							<div data-v-76b88b86="" class="col-sm-12 col-md-6">
								<div data-v-76b88b86="" class="float-md-right mb-3 mb-sm-3 mb-md-0">
									<button data-v-6f2921d8="" class="btn btn-primary" data-v-76b88b86=""> Add Designation </button>
								</div>
							</div>
						</div>
						<div>
										...
										<div class="datatable">
											...
											<div class="my-2 d-flex justify-content-between">
												<div class="d-flex align-items-center">
													<p class="text-muted mb-0"> Showing 1 to 7 items of 7 </p>
													<!---->
													<!---->
												</div>
												<!---->
	...
	window.user = {
		...
		"created_at": "2021-10-29T06:04:17.000000Z",
		"updated_at": "2021-10-29T06:04:17.000000Z",
		"deleted_at": null,
		"is_in_employee": "1",
