...
<head>
	...
	<title>Leave Status - PayDay</title>
...
<body>
	<div id="app">
        ...
        EN
              ...
              Employment Status
					...
					<li class="nav-item active"><a href="#leave" data-toggle="collapse" aria-expanded="false" aria-controls="leave" class="nav-link"><span class="icon-wrapper"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-clock menu-icon"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg></span> <span class="menu-title">Leave</span> <i class="menu-arrow"></i></a>
						<div id="leave" class="collapse show">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a href="https://payday.gainhq.com/leave/status" class="nav-link active">
              Leave Status
            </a></li>
								...
								<nav data-v-76b88b86="" aria-label="breadcrumb">
									<ol class="breadcrumb p-0 d-flex align-items-center mb-primary">
										<li class="breadcrumb-item page-header d-flex align-items-center">
											<h4 class="mb-0">Leave Status</h4></li>
										<!---->
										<!---->
									</ol>
								</nav>
            ...
            Work Shift
            <!----> <!----></a>
							<div aria-labelledby="working_shifts-undefined" class="dropdown-menu py-0">
	...
	<div class="card card-with-shadow border-0">
		...
		<div class="card-body">
			...
			<div class="remove-datatable-x-padding">
				<!---->
				<div class="datatable">
					<!---->
					<!---->
					...
					<div class="table-responsive custom-scrollbar table-view-responsive px-0">
                        ...
                        Actions
							...
							<tbody>
								<tr>
									<!---->
									<td data-title="Profile" class="datatable-td"><span class="d-inline-flex"><div class="media align-items-center min-width-200" table-id="leave-status-table"><div class="avatars-w-50"><div class="no-img rounded-circle">
        DB
				...
				<td data-title="Date &amp; time" class="datatable-td"><span class=""><div data-v-05b4c068="" class="width-150" table-id="leave-status-table" index="1"><div data-v-05b4c068="">Today</div></div></span></td>
				<td data-title="Leave duration" class="datatable-td"><span>First half</span></td>
				<td data-title="Leave Type" class="datatable-td"><span>Paid Casual</span></td>
				<td data-title="Attachments" class="datatable-td"><span class=""><div data-v-51e87be6="" table-id="leave-status-table" index="4"> <div data-v-51e87be6="">
        -
    </div></div></span></td>
				<td data-title="Activity" class="datatable-td"><span class=""><div data-v-a03a4d66="" index="5"><div data-v-8c4e629e="" data-v-a03a4d66="" id="dropdown-89" class="dropdown keep-inside-clicks-open dropdown-note-editor d-inline-block"><button data-v-8c4e629e="" type="button" data-toggle="dropdown" class="btn p-0 primary-text-color"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text size-18" data-v-8c4e629e=""><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg></button> <div data-v-8c4e629e="" class="dropdown-menu p-primary mt-1"><div data-v-8c4e629e=""><p data-v-8c4e629e="" class="text-secondary">
                Reason note
            </p> <div data-v-8c4e629e="" class="note note-warning custom-scrollbar p-4 mb-5"><p data-v-8c4e629e="" class="text-muted">
                    jkj
                </p></div> <div data-v-8c4e629e="" class="text-right"><!----> <a data-v-8c4e629e="" href="#" class="btn btn-secondary">
                        Close
                    </a></div></div></div></div> <button data-v-a03a4d66="" type="button" data-toggle="dropdown" class="btn p-0 primary-text-color"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-activity text-primary" data-v-a03a4d66=""><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg></button> <!----></div></span></td>
